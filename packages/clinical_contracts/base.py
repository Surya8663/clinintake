...
class BaseClinicalContract(BaseModel):
    ...
    workflow_id: Optional[str] = Field(default=None, description="Global workflow instance ID")
    ...
    correlation_id: Optional[str] = Field(default=None, description="Audit correlation identifier")
    idempotency_key: Optional[str] = Field(default=None, description="Idempotency key for side-effect operations")
