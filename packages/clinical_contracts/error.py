...
class ApiErrorEnvelope(BaseModel):
    ...
    dependency: Optional[str] = Field(default=None, description="Name of upstream/downstream service where failure occurred")
    trace_id: Optional[str] = Field(default=None, description="Distributed trace ID for correlation")
    document_id: Optional[str] = Field(default=None, description="Clinical document identifier")
