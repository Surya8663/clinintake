...
def test_state_1_overdue():
    ...
    response = client.post(
        "/temporal/evaluate",
        json={
            "procedure_name": "HbA1c_Testing",
            "last_screening_date": "2024-01-15",
            "patient_age": 55,
            "risk_category": "average",
            "guideline_interval_months": 12,
...
def test_state_2_due():
    ...
    response = client.post(
        ...
        json={
            ...
            "last_screening_date": "2025-01-15",
            "patient_age": 50,
            "risk_category": "average",
            "guideline_interval_months": 12,
            "reference_date": "2026-01-15"
...
def test_state_3_not_due():
    ...
    response = client.post(
        ...
        json={
            ...
            "last_screening_date": "2025-10-15",
            "patient_age": 52,
            "risk_category": "average",
            "guideline_interval_months": 12,
            "reference_date": "2026-01-15"
...
def test_state_4_insufficient_information_missing_age():
    ...
    response = client.post(
        ...
        json={
            "procedure_name": "Colonoscopy",
            "last_screening_date": "2024-05-10",
            "patient_age": None,
            "risk_category": "average",
            "guideline_interval_months": 12,
            "reference_date": "2026-01-15"
